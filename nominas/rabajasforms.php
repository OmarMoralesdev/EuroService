    ...
    <div class="wrapper">
        ...
        <div class="main p-3">
            <div class="container">
                ...
                <h2>Actualizar Rebajas Adicionales</h2>
                ...
                <?php
                    ...
                    ?>
                    <form action="rebajas.php" method="post">
                        ...
                        <br>
                        <input type="submit" class="btn btn-dark d-grid btnn gap-2 col-6 mx-auto" value="Actualizar Rebajas">
                    </form>
                </div>
            </div>
        </div>
