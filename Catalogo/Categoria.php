    ...
    <div class="main p-3">
        <div class="container">
            ...
            <div class="form-container">
                <div>
                    <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#addCategoryModal">AÑADIR NUEVA CATEGORÍA</button>
                </div>
                ...
                if ($_SERVER['REQUEST_METHOD'] === 'POST')  {
                    ...
                    if (empty($nombre) || empty($descripcion)) {
                        ...
                        if ($exists) {
                            ...
                            if ($stmt->execute()) {
                                $alertMessage = 'Categoría añadida exitosamente';
                                $alertType = 'success'; 
                            } else {
                                $alertMessage = 'Error al añadir la categoría';
                                $alertType = 'danger'; 
                            }
                        }
                    }
